                    ...
                    <div className="details-product">
                        ...
                        <div className="reviews-product">
                            ...
                            <div className="more-product">
                                Được kế thừa những chi tiết của những đôi Chuck 70 đình đám <span>{item.name}</span>{' '}
                                cũng được làm từ chất liệu vải Canvas nhưng kỹ thuật dệt hoàn hảo khiến mặt giày đẹp như
                                một bức tranh vừa bắt mắt vừa tạo ra sự ôm sát cho đôi chân người dùng.
                            </div>
                            <div className="promotion">
                                <div className="promotion-item">
                                    <i className="fas fa-check-circle"></i>
                                    <span>Tặng thêm Tote bag + Freeship với đơn hàng từ 3.000.000đ</span>
                                </div>
                                <div className="promotion-item">
                                    <i className="fas fa-check-circle"></i>
                                    <span>Tặng thêm Tote bag + Freeship với đơn hàng từ 3.000.000đ</span>
                        ...
                        <div className="description">
                            ...
                            <div className={showmore ? 'tab_content active' : 'tab_content'}>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul>
                                                    <li>
                                                        Tránh mang sản phẩm khi trời mưa hoặc thời tiết xấu để chúng
                                                        không bị ướt dẫn đến bong tróc.
                                                    </li>
                                                    <li>
                                ...
                                <p>
                                    Được kế thừa những chi tiết của những đôi <span>{item.type}</span>70 đình đám, lần
                                    này <span>{item.category}</span> lại tiếp tục tung ra một phiên bản ngọt ngào dành
                                    cho các cô nàng hiện đại, yêu thích sự ngọt ngào mà không quá lố, thích nổi bật mà
                                    vẫn phải thể hiện được sự tinh tế.
                                </p>
                                <p>
                                    <span>Chuck 70 Popped Colour</span> cũng được làm từ chất liệu vải Canvas nhưng kỹ
                                    thuật dệt hoàn hảo khiến mặt giày đẹp như một bức tranh vừa bắt mắt vừa tạo ra sự ôm
                                    sát cho đôi chân người dùng.{' '}
                                </p>
                                <img
                                ...
                                />
                                <p>
                                    Ngoài ra, phần đế giày màu trắng ngà thời thượng vừa trẻ trung vừa mang lại một vẻ
                                    vintage, bên ngoài sản phẩm được phủ sơn bóng để giày có được vẻ đẹp óng ả và sang
                                    chảnh hơn. Ở phiên bản Popped Colour Chuck 70 vừa được ra mắt, phần đế ngoài yếu tố
                                    kế thừa được truyền thống còn có những chi tiết mới như phần đế được chia thành các
                                    layer khác nhau, vừa tạo điểm nhấn vừa tạo ra sự khác biệt cho một dòng sản phẩm
                                    mới. Phần đế giày ở vị trí gót còn được đệm thêm một lớp cao su lên trên đế giày tạo
                                    hiệu ứng chồng thú vị và bắt mắt.{' '}
                                </p>
